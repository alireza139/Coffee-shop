...
import { faMapMarker, faPhoneAlt, faEnvelope } from "@fortawesome/free-solid-svg-icons";
    ...
    <div className="container-fluid footer text-white mt-5 pt-5 px-0 position-relative overlay-top">
      <div className="row mx-0 pt-5 px-sm-3 px-lg-5 mt-4">
        ...
        <div className="col-lg-3 col-md-6 mb-5">
          ...
          <p><FontAwesomeIcon icon={faMapMarker} className="mr-2" />123 Street, New York, USA</p>
          <p><FontAwesomeIcon icon={faPhoneAlt} className="mr-2" />+012 345 67890</p>
        ...
        <div className="col-lg-3 col-md-6 mb-5">
          ...
          <div className="d-flex justify-content-start">
            <a className="btn btn-lg btn-outline-light btn-lg-square mr-2" href="#"><FontAwesomeIcon icon={faTwitter} /></a>
            <a className="btn btn-lg btn-outline-light btn-lg-square mr-2" href="#"><FontAwesomeIcon icon={faFacebookF} /></a>
            <a className="btn btn-lg btn-outline-light btn-lg-square mr-2" href="#"><FontAwesomeIcon icon={faLinkedinIn} /></a>
            <a className="btn btn-lg btn-outline-light btn-lg-square" href="#"><FontAwesomeIcon icon={faInstagram} /></a>
          </div>
        </div>
